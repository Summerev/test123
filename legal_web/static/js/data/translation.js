...
const translations = {
  ko: {
    ...
    chatListHeader: "대화 목록",
    chatHeaderTitle: '법률 AI 어시스턴트',
    chatHeaderSubtitle: '복잡한 계약서, 약관 문서를 쉽게 이해하세요',
    welcomeTitle: '안녕하세요! 법률 AI 어시스턴트입니다',
    welcomeDesc:
      '계약서, 약관 내 복잡한 내용을 쉽게 설명해드립니다. 계약서, 약관에 관련된 어떤 내용이든 물어보세요',
    uploadPromptText: '2. 파일을 업로드 해주세요.',
    dragDropInstruction: '여기에 파일을 드래그 앤 드롭하거나, 아래 버튼을 눌러주세요.',
    fileTypeWarning: '(문서 유형을 먼저 선택해야 합니다.)',
    contractButtonText: '계약서',
    termsButtonText: '이용약관 및 개인정보처리방침',
    ...
    chatPlaceholder: '계약서, 약관에 관련된 질문을 하세요...',
    sendButton: '전송',
    botName: 'LegalBot',
    aiStatus: 'AI 서비스 정상 운영중',
    usageTipsTitle: '💡 사용 팁',
    tipCopyPaste: 'AI에게 문서를 업로드하세요',
    ...
    precautionReferenceOnly: '⚠️절대 법적 자문으로 간주하지 마십시오.',
    precautionConsultExpert: '참고용으로만 활용해주세요',
    precautionNoPersonalInfo: '중요한 결정은 전문가와 상담하세요',
    aiDisclaimer: '개인정보는 입력하지 마세요.',
    loginModalTitle: '로그인',
    ...
    defaultModePrefix: '',
    noRecentChats: "내보낼 대화가 없습니다.",
    confirmExportChat: "모든 대화를 내보내시겠습니까?",
    export: "내보내기",
    confirmClearChat: "모든 대화 기록을 삭제하시겠습니까?<br>이 작업은 되돌릴 수 없습니다.",
    cancel: "취소",
    deleteAll: "전체 삭제",
    chatCleared: "대화 기록이 모두 삭제되었습니다.",
    confirm: "확인",
    chatItemPrefix: 'Q: ',
    longTextPlaceholder:
    ...
    renameChat: "이름 바꾸기",
    deleteChat: "삭제",
    docTypeInstruction: "1. 처리할 문서의 유형을 선택해주세요.",
    exportChatBtn: "대화 내보내기",
    clearAllChats: "대화 전체 삭제",
    footerText: "© 2025 LegalBot | 모든 권리는 보호받습니다.",
  ...
  en: {
    ...
    chatHeaderSubtitle: 'Understand complex contracts and terms with ease.',
    welcomeTitle: "Hello! I'm the Legal AI Assistant",
    welcomeDesc: 'We simplify complex content in contracts and terms. Feel free to ask anything related to contracts or terms.',
    uploadPromptText: '2. Please upload your file.',
    ...
    termsButtonText: 'Terms of Service and Privacy Policy',
    ...
    chatPlaceholder: 'Ask questions about contracts or terms...',
    sendButton: 'Send',
    botName: 'LegalBot',
    aiStatus: 'AI Service Operating Normally',
    usageTipsTitle: '💡 Usage Tips',
    tipCopyPaste: 'Upload your document to the AI',
    ...
    precautionReferenceOnly: '⚠️ Do not consider this as legal advice.',
    precautionConsultExpert: 'Use for reference only.',
    precautionNoPersonalInfo: 'Consult a professional for important decisions.',
    aiDisclaimer: 'Do not enter any personal information.',
    ...
    defaultModePrefix: '',
    noRecentChats: "There are no chats to export.",
    confirmExportChat: "Do you want to export all chats?",
    export: "Export",
    deleteAll: "Delete All",
    chatCleared: "Chat history has been deleted.",
    confirm: "Confirm",
    chatItemPrefix: 'Q: ',
    longTextPlaceholder:
    ...
    renameChat: "Rename",
    deleteChat: "Delete",
    docTypeInstruction: "1. Please select the type of document to process.",
    footerText: "© 2025 LegalBot | All rights reserved.",
  },
  ja: {
    logoText: 'LegalBot',
    mainFeatures: '📋 主な機能',
    ...
    chatListHeader: "チャット一覧",
    chatHeaderTitle: '法律AIアシスタント',
    chatHeaderSubtitle: '複雑な契約書や利用規約をわかりやすく理解しましょう',
    welcomeTitle: 'こんにちは！法律AIアシスタントです',
    welcomeDesc: '契約書や利用規約の複雑な内容をわかりやすく説明します。契約や規約に関することなら何でも聞いてください。',
    uploadPromptText: '2. ファイルをアップロードしてください。',
    dragDropInstruction: 'ここにファイルをドラッグ＆ドロップするか、下のボタンをクリックしてください。',
    fileTypeWarning: '（文書の種類を先に選択してください。）',
    contractButtonText: '契約書',
    termsButtonText: '利用規約およびプライバシーポリシー',
    ...
    chatPlaceholder: '契約書や利用規約について質問してください...',
    sendButton: '送信',
    botName: 'リーガルボット',
    aiStatus: 'AIサービス正常稼働中',
    usageTipsTitle: '💡 利用のヒント',
    tipCopyPaste: 'AIに文書をアップロードしてください',
    ...
    precautionReferenceOnly: '⚠️ 法的な助言とはみなさないでください。',
    precautionConsultExpert: '参考用としてご利用ください。',
    precautionNoPersonalInfo: '重要な決定は専門家に相談してください。',
    aiDisclaimer: '個人情報は入力しないでください。',
    ...
    defaultModePrefix: '',
    noRecentChats: "エクスポートするチャットがありません。",
    confirmExportChat: "すべてのチャットをエクスポートしますか？",
    export: "エクスポート",
    confirmClearChat: "すべてのチャット履歴を削除しますか？<br>この操作は元に戻せません。",
    cancel: "キャンセル",
    deleteAll: "すべて削除",
    chatCleared: "チャット履歴がすべて削除されました。",
    confirm: "確認",
    chatItemPrefix: 'Q: ',
    longTextPlaceholder:
      '入力内容が長いため、契約書の可能性があります。どの部分について気になりますか？（例：第3条、リスク要因）',
    generalLegalQueryInfo:
    ...
    sampleEasyExplanationForTerm: (term) =>
      `例えば子どもに説明するとしたら、${term}は〇〇のようなものです...`,
    ...
    renameChat: "名前を変更",
    deleteChat: "削除",
    docTypeInstruction: "1. 処理する文書の種類を選択してください。",
    footerText: "© 2025 LegalBot｜全著作権所有",
  },
  zh: {
    logoText: 'LegalBot',
    mainFeatures: '📋 主要功能',
    ...
    chatHeaderSubtitle: '轻松理解复杂的合同和条款内容。',
    welcomeTitle: '你好！我是法律AI助手',
    welcomeDesc: '我们会为您简单解释合同和条款中的复杂内容。欢迎提出任何与合同或条款相关的问题。',
    uploadPromptText: '2. 请上传您的文件。',
    dragDropInstruction: '将文件拖放到此处，或点击下方按钮。',
    fileTypeWarning: '（请先选择文档类型。）',
    contractButtonText: '合同',
    termsButtonText: '服务条款和隐私政策',
    ...
    chatPlaceholder: '请就合同或条款提出问题...',
    sendButton: '发送',
    botName: '法律机器人',
    aiStatus: 'AI服务运行正常',
    usageTipsTitle: '💡 使用技巧',
    tipCopyPaste: '将文档上传给AI',
    ...
    precautionReferenceOnly: '⚠️ 请勿将其视为法律建议。',
    precautionConsultExpert: '仅供参考使用。',
    precautionNoPersonalInfo: '重要决策请咨询专业人士。',
    aiDisclaimer: '请勿输入任何个人信息。',
    loginModalTitle: '登录',
    ...
    easyModePrefix: '简单来说，',
    defaultModePrefix: '',
    noRecentChats: "没有可导出的聊天记录。",
    confirmExportChat: "是否导出所有聊天记录？",
    export: "导出",
    confirmClearChat: "是否删除所有聊天记录？<br>此操作无法撤销。",
    cancel: "取消",
    deleteAll: "全部删除",
    chatCleared: "聊天记录已全部删除。",
    confirm: "确认",
    chatItemPrefix: '问: ',
    longTextPlaceholder:
    ...
    deleteChatConfirm: '您确定要删除这条聊天记录吗？',
    cancel: '取消',
    delete: '删除',
    ...
    termDefinitionEnd: '。',
    sampleEasyExplanationForTerm: (term) => `简单来说，${term}是用来描述这类情况的词汇。`,
    greetingKeyword: '你好',
    usageTips: "💡 使用提示",
    supportDocs: "📄 支持文档",
    precautions: "⚠️ 注意事项",
    ...
    renameChat: "重命名",
    deleteChat: "删除",
    docTypeInstruction: "1. 请选择要处理的文档类型。",
    footerText: "© 2025 LegalBot | 版权所有",
  },
  es: {
    logoText: 'LegalBot',
    ...
    chatListHeader: "Lista de chats",
    chatHeaderTitle: 'Asistente Legal IA',
    chatHeaderSubtitle: 'Entiende fácilmente contratos y términos complicados.',
    welcomeTitle: '¡Hola! Soy el Asistente Legal IA',
    welcomeDesc: 'Explicamos de forma sencilla el contenido complejo de contratos y términos. Pregunta cualquier cosa relacionada con ellos.',
    uploadPromptText: '2. Por favor, suba su archivo.',
    ...
    termsButtonText: 'Términos de servicio y política de privacidad',
    ...
    chatPlaceholder: 'Haz preguntas sobre contratos o términos...',
    sendButton: 'Enviar',
    botName: 'LegalBot',
    aiStatus: 'Servicio IA Operando Normalmente',
    usageTipsTitle: '💡 Consejos de Uso',
    tipCopyPaste: 'Sube tu documento a la IA',
    ...
    precautionReferenceOnly: '⚠️ No lo consideres asesoramiento legal.',
    precautionConsultExpert: 'Utilízalo solo como referencia.',
    precautionNoPersonalInfo: 'Consulta a un experto para decisiones importantes.',
    aiDisclaimer: 'No ingreses información personal.',
    ...
    rememberMeLabel: "Mantener sesión iniciada",
    ...
    defaultModePrefix: '',
    noRecentChats: "No hay chats para exportar.",
    confirmExportChat: "¿Deseas exportar todos los chats?",
    export: "Exportar",
    confirmClearChat: "¿Deseas eliminar todo el historial de chats?<br>Esta acción no se puede deshacer.",
    deleteAll: "Eliminar todo",
    chatCleared: "El historial de chats ha sido eliminado.",
    confirm: "Confirmar",
    chatItemPrefix: 'P: ',
    longTextPlaceholder:
    ...
    deleteChat: "Eliminar",
    docTypeInstruction: "1. Por favor seleccione el tipo de documento que desea procesar.",
    footerText: "© 2025 LegalBot | Todos los derechos reservados.",
  },
};
